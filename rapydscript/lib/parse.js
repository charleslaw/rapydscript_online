...
function parse($TEXT, options) {
    ...
    function scan_for_local_vars(body, is_module) {
        ...
        if (body instanceof Array) {
            var _$rapyd$_Iter0 = dir(body);
            for (var _$rapyd$_Index0 = 0; _$rapyd$_Index0 < _$rapyd$_Iter0.length; _$rapyd$_Index0++) {
                stmt = _$rapyd$_Iter0[_$rapyd$_Index0];
    ...
    function scan_for_nonlocal_defs(body) {
        ...
        vars = [];
        if (body instanceof Array) {
            var _$rapyd$_Iter1 = dir(body);
            for (var _$rapyd$_Index1 = 0; _$rapyd$_Index1 < _$rapyd$_Iter1.length; _$rapyd$_Index1++) {
                stmt = _$rapyd$_Iter1[_$rapyd$_Index1];
                if (body[stmt] instanceof AST_Scope) {
                    continue;
                }
    ...
    function finalize_import(imp) {
        ...
        var _$rapyd$_Iter2 = dir(classes);
        for (var _$rapyd$_Index2 = 0; _$rapyd$_Index2 < _$rapyd$_Iter2.length; _$rapyd$_Index2++) {
            c = _$rapyd$_Iter2[_$rapyd$_Index2];
    ...
    class_ = function() {
        ...
        var _$rapyd$_Iter4 = dir(definition.body);
    ...
    function_ = function(in_class, ctor) {
        ...
        nonlocals.forEach(function(variable) {
            var i;
            var _$rapyd$_Iter5 = dir(definition.localvars).reverse();
    ...
    function expr_list(closing, allow_trailing_comma, allow_empty, func_call) {
        ...
        if (func_call) {
            tmp = [];
            tmp.kwargs = [];
            var _$rapyd$_Iter6 = enumerate(a);
